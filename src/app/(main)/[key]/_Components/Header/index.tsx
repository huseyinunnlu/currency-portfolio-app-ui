...
import { DotIcon, Triangle, Star, Eye } from 'lucide-react';
...
export default function Header({ liveCurrencyData, toggleFavorite, isFavorite, onOpenSheet }: HeaderPropTypes) {
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button
                                ...
                                className="cursor-pointer p-2 hover:bg-gray-100 rounded-full transition-colors md:top-auto md:right-auto -mt-4"
                            >
                                <Star
